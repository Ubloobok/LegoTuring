...
{
	public class SampleConfigForInversionVM : BaseTuringMachineVM
	{
		...
		public SampleConfigForInversionVM(IControlDevice controlDevice, ISettingsFacade settingsFacade, SharedValue<int?> sharedActiveCellIndex)
			: base(controlDevice, settingsFacade, sharedActiveCellIndex)
		{
			...
			CurrentConfig = SettingsFacade.LoadSampleConfig("ScInversion");
			InputMessage = null;
		}
